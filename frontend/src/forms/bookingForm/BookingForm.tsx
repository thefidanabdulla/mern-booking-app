import {PaymentIntentResponse, UserType} from "../../../../backend/src/shared/types.ts";
    ...
    return(
        <form onSubmit={handleSubmit(onSubmit)} className={'grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-5'}>
            ...
            <div className={'flex justify-end'}>
                <button disabled={isLoading} type={'submit'} className={'bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-base disabled:bg-gray-500'}>
